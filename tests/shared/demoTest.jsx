...
export const TriggerMockContext = React.createContext(undefined);
...
function baseText(doInject, component, options = {}) {
    ...
    files.forEach(file => {
        ...
        testMethod(doInject ? `renders ${file} extend context correctly` : `renders ${file} correctly`, () => {
            ...
            if (doInject) {
                Demo = (<TriggerMockContext.Provider value={{
                        popupVisible: true,
                    }}>
              {Demo}
...
export function extendTest(component, options = {}) {
